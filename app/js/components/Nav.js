    ...
    return (
      <nav className="site-nav" ref="site-nav">
        <div className="site-nav-header" ref="site-nav-header">
          <a className="site-nav-main-item site-nav-item logo" href="/">Kei Yasui</a>
          <p className="site-nav-sub-item site-nav-item about-content">Los Angeles Based Design and Development</p>
          <p className="site-nav-sub-item site-nav-item about-content"><a target="_blank" href="https://twitter.com/keiyasui">Twitter</a> – <a target="_blank" href="https://github.com/kyasui">Github</a> – <a target="_blank" href="https://workingnotworking.com/keiyasui">WNW</a></p>
